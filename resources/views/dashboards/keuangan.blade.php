...
<div class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <div class="px-8 pt-8 pb-6 flex justify-between items-end border-b border-gray-100 shrink-0">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight mb-2">Dasbor Keuangan</h2>
            <p class="text-gray-500 text-sm">Pantau pemasukan, pengeluaran, dan persetujuan pembelian stok.</p>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
        ...
        <!-- Financial Overview -->
        <h3 class="text-lg font-bold text-gray-900 mb-4">Ringkasan Keuangan (Sepanjang Waktu)</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-brand-red rounded-2xl p-6 shadow-sm border border-transparent flex items-center gap-4 text-white">
                ...
                <div>
                    <p class="text-sm text-white/80 font-medium">Saldo Bersih</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <h3 class="text-lg font-bold text-gray-900 mb-4">Arus Hari Ini</h3>
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-gray-700">Pemasukan Hari Ini</span>
                        </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-medium text-gray-700">Pengeluaran Hari Ini</span>
                        </div>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <h3 class="text-lg font-bold text-gray-900 mb-4">Kategori Keuangan</h3>
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between items-center">
                        <span class="text-gray-500">Pemasukan Penjualan (Kasir)</span>
                    ...
                    <div class="flex justify-between items-center mt-3">
                        <span class="text-gray-500">Pembelian Stok (Dapur)</span>
                    ...
                    <div class="flex justify-between items-center mt-3">
                        <span class="text-gray-500">Pengeluaran Gaji (SDM)</span>
        ...
        <h3 class="text-lg font-bold text-gray-900 mb-4">Persetujuan Pembelian Menunggu</h3>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <form action="{{ route('stock-transactions.updateStatus', $transaction) }}" method="POST">
                                            ...
                                            <button type="submit" class="bg-green-50 hover:bg-green-100 text-green-700 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors" onclick="return confirm('Cairkan dana dan setujui pembelian ini?')">Setujui</button>
                                        </form>
                                        <form action="{{ route('stock-transactions.updateStatus', $transaction) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <input type="hidden" name="status" value="ditolak">
                                            <button type="submit" class="bg-[#FDEAE8] hover:bg-[#FADBD8] text-brand-red px-3 py-1.5 rounded-lg text-xs font-bold transition-colors" onclick="return confirm('Tolak pembelian ini?')">Tolak</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="flex justify-between items-end mb-4">
            ...
            <a href="{{ route('financial-transactions.index') }}" class="text-sm font-semibold text-brand-red hover:underline">Lihat Semua</a>
        </div>
