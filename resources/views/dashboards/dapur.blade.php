...
<div class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <div class="px-8 pt-8 pb-6 flex justify-between items-end border-b border-gray-100 shrink-0">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight mb-2">Dasbor Dapur</h2>
            <p class="text-gray-500 text-sm">Pantau stok, kelola resep menu, dan tangani permintaan pembelian.</p>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
        ...
        <!-- Inventory Overview -->
        <h3 class="text-lg font-bold text-gray-900 mb-4">Ringkasan Persediaan</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Total Bahan</p>
        ...
        <!-- Transaction Stats -->
        <h3 class="text-lg font-bold text-gray-900 mb-4">Ringkasan Aktivitas</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Stok Masuk (Transaksi)</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Stok Keluar (Transaksi)</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Pembelian Bulanan</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="{{ route('menus.index') }}" class="group bg-white border border-gray-200 rounded-xl p-5 hover:border-brand-red hover:shadow-md transition-all flex flex-col items-center justify-center text-center gap-3">
                ...
                <span class="font-semibold text-gray-700 group-hover:text-brand-red">Kelola Menu</span>
            </a>
            ...
            <a href="{{ route('stock-transactions.create') }}" class="group bg-brand-red border border-transparent rounded-xl p-5 hover:bg-[#8B121A] hover:shadow-md transition-all flex flex-col items-center justify-center text-center gap-3">
                ...
                <span class="font-semibold text-white">Permintaan Baru</span>
            </a>
        </div>
