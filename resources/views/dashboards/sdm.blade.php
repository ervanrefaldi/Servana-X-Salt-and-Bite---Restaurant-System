...
<div class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <div class="px-8 pt-8 pb-6 flex justify-between items-end border-b border-gray-100 shrink-0">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight mb-2">HR Dashboard</h2>
            <p class="text-gray-500 text-sm">Manage staff accounts, employee records, and track payroll status.</p>
        </div>
    ...
    <div class="flex-1 overflow-y-auto p-8 custom-scrollbar">
        ...
        <!-- HR Overview -->
        <h3 class="text-lg font-bold text-gray-900 mb-4">Workforce Overview</h3>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">System Accounts</p>
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-red-100 flex items-center gap-4 relative overflow-hidden">
                ...
                <div class="z-10">
                    <p class="text-sm text-gray-500 font-medium">Unpaid Salaries</p>
        ...
        <!-- Quick Links -->
        <h3 class="text-lg font-bold text-gray-900 mb-4">HR Management</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <h4 class="font-bold text-gray-900 mb-2">Staff System Accounts</h4>
                    <p class="text-sm text-gray-500 mb-6">Manage login credentials and roles for staff members to access Servana POS.</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <h4 class="font-bold text-gray-900 mb-2">Employee Records</h4>
                    <p class="text-sm text-gray-500 mb-6">Maintain detailed profiles, positions, and contact information for all employees.</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <h4 class="font-bold text-gray-900 mb-2">Payroll Tracking</h4>
                    <p class="text-sm text-gray-500 mb-6">Review employee salary details. Note: Payments are processed by Finance.</p>
