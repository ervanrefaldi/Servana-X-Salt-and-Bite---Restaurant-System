            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('staff-accounts.update', $staffAccount) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                               name="name"
                               value="{{ old('name', $staffAccount->name) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email"
                               name="email"
                               value="{{ old('email', $staffAccount->email) }}"
                               class="w-full border-gray-300 rounded-md shadow-sm"
                               required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                               name="phone"
                               value="{{ old('phone', $staffAccount->phone) }}"
                               class="w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="is_active"
                                class="w-full border-gray-300 rounded-md shadow-sm"
                                required>
                            <option value="1" {{ old('is_active', $staffAccount->is_active) == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('is_active', $staffAccount->is_active) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            <label class="block mb-2 font-medium">Konfirmasi Password Baru</label>
                            <input type="password"
