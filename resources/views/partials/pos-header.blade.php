<header class="h-20 border-b border-gray-100 px-8 flex items-center justify-between bg-white shrink-0">
    <!-- Search Form -->
    <form action="{{ route('reservations.index') }}" method="GET" class="relative w-96">
